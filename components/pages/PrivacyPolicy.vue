                ...
                <div class="lower-box">
                  <div>
                    <p>
                      ...
                      NOMEDAEMPRESA respeitar a sua privacidade em relação a
                      qualquer informação sua que possamos coletar no site
                      NOMEDAEMPRESA, e outros sites que possuímos e operamos.
                    </p>
                    <p>
                    ...
                    <h6>Política de Cookies NOMEDAEMPRESA</h6>
                    <p class="subtitles">O que são cookies?</p>
                    <p>
                    ...
                    <p class="subtitles">Como usamos os cookies?</p>
                    <p>
                    ...
                    <p class="subtitles">Desativar cookies</p>
                    <p>
                    ...
                    <ul>
                      <li>
                        <p class="subtitles">Cookies relacionados à conta</p>
                        <p>
                      ...
                      <li>
                        <p class="subtitles">Cookies relacionados ao login</p>
                        ...
                        <p>
                          ...
                          você possa acessar apenas a recursos e áreas restritas
                          ao efetuar login.
                        </p>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <p>
                          ...
                          ou pagamento e alguns cookies são essenciais para
                          garantir que seu pedido seja lembrado entre as
                      ...
                      <li>
                        <p class="subtitles">Cookies de preferências do site</p>

                        <p>
                          Para proporcionar uma ótima experiência neste site,
                          fornecemos a funcionalidade para definir suas
                          preferências de como esse site é executado quando você
                          o usa. Para lembrar suas preferências, precisamos
                          definir cookies para que essas informações possam ser
                          chamadas sempre que você interagir com uma página for
                          afetada por suas preferências.
                        </p>
                      </li>
                    </ul>

                    <p class="subtitles">Cookies de Terceiros</p>
                    <p>
                    ...
                    <ul>
                      <li>
                        ...
                        de análise mais difundidas e confiáveis ​​da Web, para
                        nos ajudar a entender como você usa o site e como
                        podemos melhorar sua experiência. Esses cookies podem
                        rastrear itens como quanto tempo você gasta no site e as
                        páginas visitadas, para que possamos continuar
                    ...
                    <p class="subtitles">Compromisso do Usuário</p>
                    <p>
                      O usuário se compromete a fazer uso adequado dos conteúdos
                      e da informação que o NOMEDAEMPRESA oferece no site e com
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        racista, xenofóbica, ou salmao, casas de apostas (ex.:
                        Betway), jogos de sorte e azar, qualquer tipo de
                        pornografia ilegal, de apologia ao terrorismo ou contra
                        os direitos humanos;
                      </li>
                      <li>
                        C) Não causar danos aos sistemas físicos (hardwares) e
                        lógicos (softwares) do NOMEDAEMPRESA, de seus
                    ...
                    <p class="subtitles">Mais informações</p>
                    <p>
                      ...
                      em nosso site. Esta política é efetiva a partir de
                      fevereiro de 2021.
                    </p>
                  </div>
                </div>
